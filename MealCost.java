...
public class MealCost {
    public static void main(String[] args) {
        ...
        double originalCost;
        double costWithTipnTax;
        
        //finals are used since rates are fixed values
        final double taxRate = 0.0675; // 6.75% tax rate
        final double tipRate = 0.20;   // 20% tip
        ...
        double taxedAmount = originalCost*taxRate;
        System.out.print("\n" + "The tax is: $");
        System.out.printf("%1.2f",(taxedAmount));
        
        //calculates amount to tip
        double tippedAmount = originalCost*tipRate;
        System.out.print("\n" + "The tax is: $");
        System.out.printf("%1.2f",(tippedAmount));
        
        //calculates overall cost of meal
        costWithTipnTax = originalCost + taxedAmount + tippedAmount;
        System.out.print("\n" + "The meal cost with tax and tip is: $");
        System.out.printf("%1.2f",(costWithTipnTax));
    }
}